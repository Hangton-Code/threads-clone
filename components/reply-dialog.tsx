...
import { replayDialogUseSubmit } from "./reply-dialog-use-submit";
...
export function ReplyDialog({
  ...
  const onSubmit = replayDialogUseSubmit(
    thread,
    content,
    attachment,
    setIsLoading,
  ...
  return (
    <Dialog>
      ...
      <DialogContent>
        ...
        <form onSubmit={onSubmit} className="gap-4 grid">
          <div className="flex gap-4 overflow-visible">
            ...
            <div className="w-full flex flex-col gap-2 overflow-visible">
              ...
              <Textarea
                className="h-60"
                placeholder={`Reply to ${author.user_name}`}
                value={content}
